...
function About() {
    return (
        ...
        <section className="values-wrapper">
            <Collapse details={companyValues.fiabilité} summary="Fiabilité" page="about"/>
            <Collapse details={companyValues.respect} summary="Respect" page="about"/>
            <Collapse details={companyValues.service} summary="Service" page="about"/>
            <Collapse details={companyValues.securité} summary="Securité" page="about"/>
        </section>
        </>
    );
}
